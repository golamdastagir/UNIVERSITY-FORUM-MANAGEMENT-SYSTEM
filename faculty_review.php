...
<body>
    ...
    <div class="container d-flex flex-column align-items-center">
        ...
        <div class="container-sm" style="width: 600px">
            <form action="faculty_review.php" method="POST">


                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label" for="">Faculty Name</label>
                    <div class="col-sm-10">   
                        <input class="form-control" type="text" name='name' placeholder="Faculty Name" value="" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">   
                        <input class="form-control" type="text" name='course' placeholder="Course you did under him/her" maxlength="6" value="" required>
                    </div>
                </div>
...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $sql = "INSERT INTO review_faculty(name, course, department, email, rating, review) VALUES('$name','$course', '$department', '$email', '$rating', '$review')";

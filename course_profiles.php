      ...
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                    <a class="nav-link" href="course_review.php">Give a Course Review</a>
              </li>
              <li class="nav-item">
...
<div class="container d-flex flex-column align-items-center">
    ...
    <?php foreach ($report as $item): ?>
      <?php
        if ($item['name']!= $name3):
        $name3 = $item['course'];
        $sql3 = "SELECT DISTINCT course, name, department, avg(rating) as rate FROM review_course WHERE course = '$name3'";
      ...
      <?php foreach ($report3 as $item3): ?>
        ...
        <div class="card my-3 w-75">
          <div class="card-body text-auto">
            ...
            <h3 style="text-align: center" ><?php echo $item3['course']; ?> <br></h3>
            <h5>
            <b>Course name:</b> <?php echo $item3['name']; ?> <br>
